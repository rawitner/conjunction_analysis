...
## Worst offender analysis-- Method 1 (Rachel's method)
...
```{r }
top50 %>% dplyr::select(c("noradId", "totalRisk", "numConjs","closestApproach(km)",
                          "avgNumOpSats","medianNumOpSats",
                          "avgPersistenceOfConjAlt(yrs)",
                          "medianPersistenceOfConjAlt(yrs)", "apogee", "perigee",
