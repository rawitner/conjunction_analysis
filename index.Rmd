...
alt_bins = opSats %>% #mcma_objs %>% 
  ...
  mutate(spatDensOpSats = numOpSats / volume * (10^8))
...
```{r getSMC}
cols_ordered = c("noradId", "name","cluster_new","SMC_risk", "E5", "E1", "spatDens", "df", "AR", "MF","velocity","SD","AC","CR",
