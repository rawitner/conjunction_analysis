...
- E.5 = number of encounters < 0.5 km per year

Consequence:

- MF = $\frac{mass~of~object}{9000}$
...
all_conjs_expanded %>% 
  ...
  mutate(E_tot = replace_na(numtot, 0),
         E1 = replace_na(num1, 0),
         E.5 = replace_na(num.5, 0),
         AR = ) #%>%
  #View()
